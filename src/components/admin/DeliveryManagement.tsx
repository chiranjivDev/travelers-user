...
const mockDeliveries = [
  {
    ...
    items: [{ name: 'Electronics', quantity: 1, declared_value: 500 }],
  ...
  },
  {
    ...
    items: [{ name: 'Documents', quantity: 1, declared_value: 100 }],
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          {
            title: 'Completed',
            value: mockDeliveries.filter((d) => d.status === 'completed')
              .length,
            icon: FiCheck,
      ...
      <div className="flex space-x-4">
        {['all', 'pending', 'in-progress', 'completed', 'disputed'].map(
          (status) => (
            <button
              key={status}
