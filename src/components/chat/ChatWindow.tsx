...
export default function ChatWindow() {
  ...
  return (
    <div className="flex-1 scrollbar-none max-sm:max-h-svh max-sm:absolute max-sm:top-20 max-sm:left-0 flex flex-col bg-gray-900">
      {/* Chat Header */}
      <div className="p-4 border-b border-gray-700 flex sm-max:gap-4 items-center justify-between">
        <div className="flex sm:hidden items-center justify-center mr-3">
          <button
            className="bg-blue-500 px-3 py-2 rounded-3xl"
        ...
        <div className="flex max-sm:flex-1 items-center  space-x-3">
          <div className="relative">
            ...
            />
            <div
              className={`absolute bottom-0 right-0 w-2 h-2 sm:w-3 sm:h-3 rounded-full border-2 border-gray-900 ${
                otherUser.status === 'online' ? 'bg-green-500' : 'bg-gray-500'
              }`}
            />
          </div>
          <div>
            <h3 className="font-medium max-sm:font-base max-sm:text-sm text-white">
              {otherUser.name}{' '}
            </h3>
        ...
        <div className="flex max-sm:flex-col max-sm:gap-2 items-center space-x-6">
          ...
          <div className="flex items-center max-sm:justify-center w-full gap-6">
      ...
      {/* Messages */}
      <div className="flex-1 scrollbar-none overflow-y-auto max-h-[26rem] p-4">
        {showPackageDetails && (
          <PackageInformation
