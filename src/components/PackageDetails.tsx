...
export default function PackageDetails({ value, onChange }: PackageDetailsProps) {
  return (
    <div className="bg-white rounded-lg p-6">
      <h2 className="text-2xl font-bold mb-4">Package Details</h2>
      
      <div className="mb-6">
        <h3 className="text-lg font-medium mb-4">Choose Package Size</h3>
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            {['Length', 'Width', 'Height'].map((dimension) => (
              <div key={dimension}>
                <label className="block text-sm font-medium text-gray-700">{dimension} (cm)</label>
                <input
                  type="number"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
