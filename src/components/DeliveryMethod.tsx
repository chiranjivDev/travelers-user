...
const ContactDetails = ({
  ...
  return (
    <div className="space-y-3 pl-4 border-l-2 border-gray-200 transition-all duration-200 ease-in-out">
...
export default function DeliveryMethod({
  ...
  const inputClassName =
    'w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 shadow-sm transition-colors duration-200 placeholder-gray-500';
  const checkboxClassName =
    'w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 transition-colors duration-200';
  const labelClassName = 'text-sm font-medium text-gray-700 mb-1 block';
  const selectClassName =
    'w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 shadow-sm transition-colors duration-200';
  ...
  const steps = [
    {
      ...
      subtitle:
        type === 'pickup'
          ? 'Where should the traveler collect your package?'
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold mb-4">
                    ...
                    >
                      Default {type === 'pickup' ? 'Pickup' : 'Delivery'}{' '}
                      Location
                    </Tooltip>
                  </h3>
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <label className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          checked={
                            value?.packageHandling?.requiresCarefulHandling ||
                            false
                          }
                          onChange={(e) =>
                            onChange({
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
                      ...
                      <div>
                        <label className={labelClassName}>
                          When do you want to send the package?
                        </label>
                        <input
                          type="date"
                          value={
                            value?.timing?.sendingDate?.preferredDate || ''
                          }
                      ...
                      <label className="flex items-center space-x-2 mt-2">
                        <input
                          type="checkbox"
                          checked={
                            value?.timing?.sendingDate?.isFlexible || false
                          }
                          onChange={(e) =>
                            onChange({
                              ...value,
                        ...
                        />
                        <span className="text-sm text-gray-700">
                          I'm flexible with the sending date
                        </span>
                      </label>
                    ...
                    <div className="space-y-4 mt-6 p-4 bg-white rounded-lg border border-gray-200">
                      ...
                      <div>
                        <label className={labelClassName}>
                          When should the package be delivered?
                        </label>
                        <input
                          type="date"
                          value={
                            value?.timing?.deliveryDate?.preferredDate || ''
                          }
                          min={
                            value?.timing?.sendingDate?.preferredDate ||
                            new Date().toISOString().split('T')[0]
                      ...
                      <label className="flex items-center space-x-2 mt-2">
                        <input
                          type="checkbox"
                          checked={
                            value?.timing?.deliveryDate?.isFlexible || false
                          }
                          onChange={(e) =>
                            onChange({
                              ...value,
                        ...
                        />
                        <span className="text-sm text-gray-700">
                          I'm flexible with the delivery date
                        </span>
                      </label>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <label className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-sm text-gray-700">
                          Allow postal delivery if needed
                        </span>
                      </label>
                      ...
                      {value?.allowPostalDelivery && (
                        <div className="ml-6 p-4 bg-blue-50 rounded-lg">
                          <p className="text-sm text-blue-800 mb-2">
                            Note: If the traveler is in a different city, postal
                            delivery costs will be covered by you (the sender).
                          </p>
                          <div className="space-y-3">
                            <div>
                              <label className={labelClassName}>
                              ...
                              <input
                                type="text"
                                value={
                                  value?.postalDeliveryDetails?.senderCity || ''
                                }
                                onChange={(e) =>
                                  onChange({
                                    ...value,
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-wrap gap-4">
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) =>
                            handleTimeChange('morning', e.target.checked)
                          }
                          className={checkboxClassName}
                        />
                        <span className="text-sm text-gray-700">
                      ...
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) =>
                            handleTimeChange('afternoon', e.target.checked)
                          }
                          className={checkboxClassName}
                        />
                        <span className="text-sm text-gray-700">
                      ...
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) =>
                            handleTimeChange('evening', e.target.checked)
                          }
                          className={checkboxClassName}
                        />
                        <span className="text-sm text-gray-700">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e) =>
                          handleTimeChange('flexibleDays', e.target.checked)
                        }
                        className={checkboxClassName}
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Optional: Set a specific preferred time
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {currentStep === 3 && type === 'pickup' && (
                  <div className="mt-6 border-t border-gray-200 pt-6">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                      Please verify the package details during pickup. This
                      helps ensure smooth delivery and proper handling.
                    </p>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {['length', 'width', 'height'].map((dimension) => (
                          <div key={dimension}>
                            <label
                              htmlFor={dimension}
                              className="block text-xs text-gray-500 capitalize mb-1"
                            >
                              {dimension}
                            </label>
                              ...
                              <input
                                ...
                                value={
                                  value?.packageDetails?.dimensions?.[
                                    dimension as keyof typeof value.packageDetails.dimensions
                                  ] || ''
                                }
                                onChange={(e) => {
                                  const newValue = {
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Please measure the package accurately to ensure proper
                ...
                <div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-600 mt-1">
                          Our secure in-app messaging system protects your
                          privacy by keeping your contact details private until
                  ...
                  <div className="mt-4">
                    <label className="flex items-center space-x-2">
                      ...
                      />
                      <span className="text-sm text-gray-700">
                        Enable secure in-app messaging
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="mt-6">
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Your contact information will remain private and will
                          only be shared with matched travelers after you
                          approve them.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 ml-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <label className="flex items-center space-x-2">
                          <input
                            type="checkbox"
                            checked={
                              value?.communicationPreferences?.phone || false
                            }
                            onChange={(e) =>
                              onChange({
                                ...value,
                      ...
                      {(value?.communicationPreferences?.whatsapp ||
                        ...
                        <div className="p-4 bg-gray-50 rounded-lg space-y-4">
                          <div>
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              ⚠️ Your number will remain private until you
                              approve a specific traveler
                            </p>
                          </div>
                        </div>
                      )}
