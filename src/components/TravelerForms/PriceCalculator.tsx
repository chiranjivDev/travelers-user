...
const PriceCalculator: React.FC<PriceCalculatorProps> = ({
  ...
  const calculateTotalPrice = ({
    ...
    const multiplier =
      RATES.PACKAGE_TYPE_MULTIPLIERS[
        packageType as keyof typeof RATES.PACKAGE_TYPE_MULTIPLIERS
      ] || 1;
    total *= multiplier;
  ...
  const getPriceBreakdown = (factors: PricingFactors) => {
    ...
    const multiplier =
      RATES.PACKAGE_TYPE_MULTIPLIERS[
        factors.packageType as keyof typeof RATES.PACKAGE_TYPE_MULTIPLIERS
      ] || 1;
    ...
    const breakdown = {
      ...
      urgentDeliveryFee: factors.urgentDelivery
        ? withPackageType * (RATES.URGENT_DELIVERY_MULTIPLIER - 1)
        : 0,
    };
    return breakdown;
  };
