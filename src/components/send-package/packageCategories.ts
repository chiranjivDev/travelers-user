...
export const packageCategories: Category[] = [
  {
    ...
    description:
      "Can't find your category? Select this option and provide details about your item. Our team will assist you with proper handling.",
    subcategories: [
      {
        id: 'custom_item',
        name: 'Custom Item',
        description:
          'Describe your item in detail. Include dimensions, weight, and any special handling requirements.',
      },
      {
        id: 'unique',
        name: 'Unique / One-of-a-kind Item',
        description:
          "For items that don't fit standard categories. Please provide detailed information for proper handling.",
      },
      {
        id: 'mixed',
        name: 'Mixed Items',
        description:
          'For packages containing multiple different types of items.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'office', name: 'Office Electronics' },
      {
        ...
        description:
          'For electronic items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'maternity', name: 'Maternity Clothing' },
      {
        ...
        name: 'Other Clothing',
        description:
          'For clothing items not listed above. Please specify the type and any special care requirements.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'safety', name: 'Home Safety & Security' },
      {
        ...
        description:
          'For home items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'maps', name: 'Maps & Atlases' },
      {
        ...
        description:
          'For books and media items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'storage', name: 'Storage Solutions' },
      {
        ...
        description:
          'For business items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'installations', name: 'Art Installations' },
      {
        ...
        description:
          'For art and collectibles items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'accessories', name: 'Sports Accessories' },
      {
        ...
        description:
          'For sports and recreation items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'safety', name: 'Safety Equipment' },
      {
        ...
        description:
          'For automotive and parts items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'other', name: 'Other Fragile Items' },
      {
        ...
        description:
          'For fragile and specialty items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { id: 'spare_parts', name: 'Spare Parts' },
      {
        ...
        description:
          'For industrial and manufacturing items not listed above. Please specify the type and any special handling needs.',
      },
    ],
  },
];
