...
const RESTRICTED_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      { name: 'Counterfeit Money', severity: 'high', description: 'Fake currency of any kind', restrictions: 'Completely prohibited', countries: ['All'], icon: '💵' },
      { name: 'Unregistered Gold', severity: 'high', description: 'Undeclared precious metals', restrictions: 'Declaration required', countries: ['All'], icon: '🏆' },
      { name: 'Bearer Bonds', severity: 'high', description: 'Large quantities', restrictions: 'Declaration required', countries: ['All'], icon: '📄' },
      { name: 'Valuable Coins', severity: 'medium', description: 'Without permits', restrictions: 'Declaration required', countries: ['All'], icon: '🪙' },
      { name: 'Raw Gems', severity: 'high', description: 'Unprocessed precious stones', restrictions: 'Declaration required', countries: ['All'], icon: '💎' },
      { name: 'Uncut Diamonds', severity: 'high', description: 'Without Kimberley certification', restrictions: 'Certification required', countries: ['All'], icon: '💎' },
      { name: 'Crypto Hardware', severity: 'medium', description: 'In restricted countries', restrictions: 'Country-specific restrictions', countries: ['Iran'], icon: '💻' },
      { name: 'Large Cash', severity: 'medium', description: 'Exceeding legal limits', restrictions: 'Declaration required', countries: ['All'], icon: '💵' },
      { name: 'Gambling Devices', severity: 'high', description: 'Any gambling equipment', restrictions: 'Country-specific restrictions', countries: ['Iran'], icon: '🎲' }
    ]
  },
  {
    id: 'weapons',
    ...
    icon: '🔫',
    description: 'Firearms, ammunition, and related items',
    items: [
      { name: 'Firearms', severity: 'high', description: 'Any type of gun or firearm', restrictions: 'Completely prohibited', countries: ['All'], icon: '🔫' },
      { name: 'Ammunition', severity: 'high', description: 'Any type of bullets or shells', restrictions: 'Completely prohibited', countries: ['All'], icon: '🎯' },
      { name: 'Explosives', severity: 'high', description: 'Any explosive materials', restrictions: 'Completely prohibited', countries: ['All'], icon: '💥' },
      { name: 'Replicas', severity: 'high', description: 'Replica or toy weapons', restrictions: 'Restricted', countries: ['All'], icon: '⚔️' },
      { name: 'Knives', severity: 'high', description: 'Combat or hunting knives', restrictions: 'Restricted', countries: ['All'], icon: '🔪' },
      { name: 'Martial Arts', severity: 'medium', description: 'Martial arts weapons', restrictions: 'Restricted', countries: ['All'], icon: '🥋' }
    ]
  },
  {
    id: 'cultural',
    title: 'Cultural and Historical Items',
    icon: '🏺',
    description: 'Protected artifacts and cultural heritage items',
    items: [
      { name: 'Antiques', severity: 'high', description: 'Historical artifacts', restrictions: 'Documentation required', countries: ['All'], icon: '🏺' },
      { name: 'Religious Items', severity: 'medium', description: 'Sacred objects', restrictions: 'Documentation required', countries: ['All'], icon: '⛪' },
      { name: 'Fossils', severity: 'high', description: 'Any prehistoric remains', restrictions: 'Documentation required', countries: ['All'], icon: '🦕' },
      { name: 'Art', severity: 'medium', description: 'Valuable artwork', restrictions: 'Documentation required', countries: ['All'], icon: '🎨' }
    ]
  },
  {
    id: 'wildlife',
    title: 'Wildlife and Animal Products',
    icon: '🦁',
    description: 'Protected species and animal-derived items',
    items: [
      { name: 'Ivory', severity: 'high', description: 'Any ivory products', restrictions: 'Completely prohibited', countries: ['All'], icon: '🐘' },
      { name: 'Animal Parts', severity: 'high', description: 'Protected species parts', restrictions: 'Completely prohibited', countries: ['All'], icon: '🦁' },
      { name: 'Live Animals', severity: 'high', description: 'Any live creatures', restrictions: 'Special permits required', countries: ['All'], icon: '🐾' },
      { name: 'Fur Products', severity: 'high', description: 'From protected species', restrictions: 'Documentation required', countries: ['All'], icon: '🦊' }
    ]
  },
  {
    id: 'agriculture',
    ...
    items: [
      { name: 'Seeds', severity: 'medium', description: 'Any plant seeds', restrictions: 'Documentation required', countries: ['All'], icon: '🌱' },
      { name: 'Plants', severity: 'medium', description: 'Live plants', restrictions: 'Documentation required', countries: ['All'], icon: '🌿' },
      { name: 'Soil', severity: 'medium', description: 'Any type of soil', restrictions: 'Usually prohibited', countries: ['All'], icon: '🌍' },
      { name: 'Fresh Produce', severity: 'medium', description: 'Fruits and vegetables', restrictions: 'Restrictions apply', countries: ['All'], icon: '🍎' }
    ]
  },
  {
    id: 'media',
    ...
    icon: '💽',
    description: 'Restricted media content and information',
    items: [
      { name: 'Propaganda', severity: 'high', description: 'Political materials', restrictions: 'May be restricted', countries: ['All'], icon: '📰' },
      { name: 'State Secrets', severity: 'high', description: 'Classified information', restrictions: 'Completely prohibited', countries: ['All'], icon: '🔒' },
      { name: 'Counterfeit Media', severity: 'high', description: 'Pirated content', restrictions: 'Completely prohibited', countries: ['All'], icon: '💿' }
    ]
  }
];
